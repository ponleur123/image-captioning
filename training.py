...
from transformers import VisionEncoderDecoderModel, XLMRobertaForCausalLM, ViTImageProcessor
from transformers import AutoTokenizer ,  AutoImageProcessor , default_data_collator,XLMRobertaTokenizer
...
decoder_models = ["channudam/khmer-xlm-roberta-base"]

rouge = datasets.load_metric("rouge")

# Loop through encoders and decoders
for encoder_model in encoder_models:
    for decoder_model in decoder_models:
        print(f"Training with Encoder: {encoder_model} and Decoder: {decoder_model}")
        ...
        tokenizer = XLMRobertaTokenizer.from_pretrained(decoder_model)
        ...
        out_directory = f'/home/ponleur.veng/image-caption/output_training/{encoder_model.split("/")[1]}-{decoder_model.split("/")[1]}'
        ...
        print(f"Finished training Encoder: {encoder_model} and Decoder: {decoder_model}")
